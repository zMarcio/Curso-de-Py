...
# idades = {'Júlia': 16, 'Carol': 23, 'Alberto': 19, 'Roberta': 17}, armazenando o resultado do valor em uma variável. 
...
try:
    dig_Chave = input('Digite sua chave')
    resposta = idades[dig_Chave]
except Exception as e :
    print(e.__class__.__name__, ', Nome não encontrado')
else:
    print('entra aqui')
    print(resposta)